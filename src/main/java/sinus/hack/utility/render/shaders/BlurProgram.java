package sinus.hack.utility.render.shaders;
...
import sinus.hack.utility.render.WindowResizeCallback;
import sinus.hack.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import sinus.hack.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import sinus.hack.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("sinushack", "blur"), VertexFormats.POSITION);
