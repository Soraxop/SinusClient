...
import sinus.hack.features.hud.impl.*;
import sinus.hack.features.modules.client.*;
import sinus.hack.features.modules.combat.*;
import sinus.hack.features.modules.misc.*;
import sinus.hack.features.modules.movement.*;
import sinus.hack.features.modules.movement.Timer;
import sinus.hack.features.modules.player.*;
import sinus.hack.features.modules.render.*;
import sinus.hack.features.modules.render.Particles;
...
public class ModuleManager implements IManager {
    ...
    public static SinusHackGui sinusHackGui = new SinusHackGui();
    ...
    public void onLoad(String category) {
        try {
            SinusHack.EVENT_BUS.unsubscribe(unHook);
        ...
        modules.forEach(m -> {
            if (m.isEnabled() && (m.getCategory().getName().equalsIgnoreCase(category) || category.equals("none")))
                SinusHack.EVENT_BUS.subscribe(m);
        });
    ...
    public void onRender2D(DrawContext context) {
        ...
        SinusHack.core.onRender2D(context);
    }
    ...
    public void onUnload(String category) {
        modules.forEach(module -> {
            if (module.isEnabled() && (module.getCategory().getName().equalsIgnoreCase(category) || category.equals("none"))) {
                SinusHack.EVENT_BUS.unsubscribe(module);
    ...
    public void registerModule(Module module) {
        ...
        if (module.isEnabled())
            SinusHack.EVENT_BUS.subscribe(module);
    }
