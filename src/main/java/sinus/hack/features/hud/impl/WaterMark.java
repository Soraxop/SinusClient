...
import sinus.hack.features.modules.misc.NameProtect;
...
import sinus.hack.utility.render.TextUtil;
...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.thglitch.drawString(context.getMatrices(), "SINUSHACK", getPosX() + 5.5, getPosY() + 5, -1);
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                float width = FontRenderers.sf_bold.getStringWidth("SinusHack " + info) + 5;
                Render2DEngine.drawHudBase(context.getMatrices(), getPosX(), getPosY(), width, 10, 3);
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), ru.getValue() ? textUtil + " " : "SinusHack ", getPosX() + 2, getPosY() + 2.5f, 10);
                FontRenderers.sf_bold.drawString(context.getMatrices(), info, getPosX() + 2 + FontRenderers.sf_bold.getStringWidth("SinusHack "), getPosY() + 2.5f, HudEditor.textColor.getValue().getColor());
            ...
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "SinusHack v" + SinusHack.VERSION, getPosX() + 5.5f, getPosY() + 5, 10);
