...
import static sinus.hack.utility.render.Render2DEngine.applyOpacity;
...
public class JumpCircle extends Module {
    ...
    public void onEnable() {
        try {
            custom = SinusUtility.getCustomImg("circle");
        } catch (Exception e) {
    ...
    public void onUpdate() {
        if (mode.is(Mode.Custom) && custom == null) {
            try {
                ...
                sendMessage(".minecraft -> SinusHackRecode -> misc -> images -> circle.png");
            }
        }
