package sinus.hack.gui.clickui;
...
import sinus.hack.features.modules.client.BaritoneSettings;
import sinus.hack.features.modules.client.ClickGui;
import sinus.hack.features.modules.client.HudEditor;
import sinus.hack.gui.clickui.impl.SearchBar;
...
public class Category extends AbstractCategory {
    ...
    public Category(Module.Category category, ArrayList<Module> features, float x, float y, float width, float height) {
        ...
        ICON = Identifier.of("sinushack", "textures/gui/headers/" + (Module.Category.isCustomCategory(category) ? "stock" : category.getName().toLowerCase()) + ".png");

        if (category.getName().equals("Client"))
            buttons.add(new SearchBar());

        features.forEach(feature -> {
            if (!(feature instanceof BaritoneSettings) || SinusHack.baritone)
