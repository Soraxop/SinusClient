...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) SinusHack.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(SinusHack.copy_color == null ? getColorSetting().getColorObject() : SinusHack.copy_color);
    }
