...
import sinus.hack.utility.render.animation.AnimationUtility;
...
public class ModulePlate {
    ...
    public void render(MatrixStack stack, int MouseX, int MouseY) {
        ...
        if ((posY > SinusGui.getInstance().main_posY + SinusGui.getInstance().height) || posY < SinusGui.getInstance().main_posY) {
            return;
        }
        ...
        if (module.isOn()) {
            Render2DEngine.drawGradientRound(stack, posX + 1, posY, 89, 30, 4f,
                    Render2DEngine.applyOpacity(SinusHackGui.onColor1.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(SinusHackGui.onColor1.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(SinusHackGui.onColor2.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(SinusHackGui.onColor2.getValue().getColorObject(), getFadeFactor()));
        } else {
        ...
        if (SinusGui.selected_plate != this)
        ...
        if (listening_bind) {
            ...
            if (!holdbind) {
                Render2DEngine.drawRound(stack, posX + 6, posY + 6, 38, 8, 2, Render2DEngine.injectAlpha(SinusHackGui.onColor1.getValue().getColorObject(), 170));
                ...
                Render2DEngine.drawRound(stack, posX + 6, posY + 16, 38, 8, 2, Render2DEngine.injectAlpha(SinusHackGui.onColor1.getValue().getColorObject(), 170));
